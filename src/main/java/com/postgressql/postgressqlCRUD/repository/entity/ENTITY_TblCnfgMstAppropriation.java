...
@Entity
@Table(name = "TBL_CNFG_MST_APPROPRIATION", schema = "dbo", catalog = "master")
public class ENTITY_TblCnfgMstAppropriation {
    ...
    @Basic
    @Column(name = "VB_INSTALLMENTELEMENT", nullable = false, precision = 0)
    private int vbInstallmentelement;
    @Basic
    ...
    public int getVbInstallmentelement() {
        return vbInstallmentelement;
    }

    public void setVbInstallmentelement(int vbInstallmentelement) {
        this.vbInstallmentelement = vbInstallmentelement;
    }
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblCnfgMstAppropriation that = (ENTITY_TblCnfgMstAppropriation) o;

        if (recid != that.recid) return false;
        if (financierid != that.financierid) return false;
        if (vbInstallmentelement != that.vbInstallmentelement) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + vbInstallmentelement;
