...
@Entity
@Table(name = "TBL_CNFG_SCHEME_RESIDUAL", schema = "dbo", catalog = "master")
public class ENTITY_TblCnfgSchemeResidual {
    ...
    private int ruleid;
    @Basic
    @Column(name = "RESIDUALPERCENT", nullable = true, precision = 2)
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblCnfgSchemeResidual that = (ENTITY_TblCnfgSchemeResidual) o;
        ...
        if (residualpercent != null ? !residualpercent.equals(that.residualpercent) : that.residualpercent != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (residualpercent != null ? residualpercent.hashCode() : 0);
