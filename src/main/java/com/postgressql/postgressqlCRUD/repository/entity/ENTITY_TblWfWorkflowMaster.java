...
@Entity
@Table(name = "TBL_WF_WORKFLOW_MASTER", schema = "dbo", catalog = "master")
public class ENTITY_TblWfWorkflowMaster {
    ...
    private int eventid;
    @Basic
    @Column(name = "DESCRIPTION1", nullable = true, length = 250)
    private String description1;
    @Basic
    @Column(name = "DESCRIPTION2", nullable = true, length = 250)
    private String description2;
    @Basic
    @Column(name = "DESCRIPTION3", nullable = true, length = 250)
    ...
    @OneToMany(mappedBy = "tblWfWorkflowMasterByWorkflowid")
    private Collection<ENTITY_TblWfWorkflowDetails> tblWfWorkflowDetailsByWorkflowid;
    @ManyToOne
    ...
    private ENTITY_TblWfMasterEvents tblWfMasterEventsByEventid;
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblWfWorkflowMaster that = (ENTITY_TblWfWorkflowMaster) o;
        ...
        if (description3 != null ? !description3.equals(that.description3) : that.description3 != null) return false;
    ...
    public Collection<ENTITY_TblWfWorkflowDetails> getTblWfWorkflowDetailsByWorkflowid() {
        return tblWfWorkflowDetailsByWorkflowid;
    }

    public void setTblWfWorkflowDetailsByWorkflowid(Collection<ENTITY_TblWfWorkflowDetails> tblWfWorkflowDetailsByWorkflowid) {
        this.tblWfWorkflowDetailsByWorkflowid = tblWfWorkflowDetailsByWorkflowid;
    }
    ...
    public ENTITY_TblWfMasterEvents getTblWfMasterEventsByEventid() {
        return tblWfMasterEventsByEventid;
    }

    public void setTblWfMasterEventsByEventid(ENTITY_TblWfMasterEvents tblWfMasterEventsByEventid) {
        this.tblWfMasterEventsByEventid = tblWfMasterEventsByEventid;
    }
}
