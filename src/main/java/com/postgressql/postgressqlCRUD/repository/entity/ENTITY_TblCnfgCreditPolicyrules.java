...
@Entity
@Table(name = "TBL_CNFG_CREDIT_POLICYRULES", schema = "dbo", catalog = "master")
public class ENTITY_TblCnfgCreditPolicyrules {
    ...
    private int ruleid;
    @Basic
    @Column(name = "ROLEID_APPROVER", nullable = false, precision = 0)
    private int roleidApprover;
    @Basic
    ...
    public int getRoleidApprover() {
        return roleidApprover;
    }

    public void setRoleidApprover(int roleidApprover) {
        this.roleidApprover = roleidApprover;
    }
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblCnfgCreditPolicyrules that = (ENTITY_TblCnfgCreditPolicyrules) o;

        if (recid != that.recid) return false;
        if (financierid != that.financierid) return false;
        if (ruleid != that.ruleid) return false;
        if (roleidApprover != that.roleidApprover) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + roleidApprover;
