...
@Entity
@Table(name = "TBL_UM_USER_BRANCH", schema = "dbo", catalog = "master")
public class ENTITY_TblUmUserBranch {
    ...
    @Basic
    @Column(name = "BRANCHID", nullable = false, precision = 0, insertable=false, updatable=false)
    ...
    private ENTITY_TblCnfgMstBranch tblCnfgMstBranchByBranchid;
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblUmUserBranch that = (ENTITY_TblUmUserBranch) o;
    ...
    public ENTITY_TblCnfgMstBranch getTblCnfgMstBranchByBranchid() {
        return tblCnfgMstBranchByBranchid;
    }

    public void setTblCnfgMstBranchByBranchid(ENTITY_TblCnfgMstBranch tblCnfgMstBranchByBranchid) {
        this.tblCnfgMstBranchByBranchid = tblCnfgMstBranchByBranchid;
    }
}
