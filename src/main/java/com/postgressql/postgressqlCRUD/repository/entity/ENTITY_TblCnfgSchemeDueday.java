...
@Entity
@Table(name = "TBL_CNFG_SCHEME_DUEDAY", schema = "dbo", catalog = "master")
public class ENTITY_TblCnfgSchemeDueday {
    ...
    private int ruleid;
    @Basic
    @Column(name = "VB_DUEDAY", nullable = false, precision = 0)
    private int vbDueday;
    @Basic
    @Column(name = "DUEDAYCUTOFFDAYS", nullable = false)
    private int duedaycutoffdays;
    @Basic
    ...
    public int getVbDueday() {
        return vbDueday;
    }

    public void setVbDueday(int vbDueday) {
        this.vbDueday = vbDueday;
    }

    public int getDuedaycutoffdays() {
        return duedaycutoffdays;
    }

    public void setDuedaycutoffdays(int duedaycutoffdays) {
        this.duedaycutoffdays = duedaycutoffdays;
    }
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblCnfgSchemeDueday that = (ENTITY_TblCnfgSchemeDueday) o;

        if (recid != that.recid) return false;
        if (schemeid != that.schemeid) return false;
        if (ruleid != that.ruleid) return false;
        if (vbDueday != that.vbDueday) return false;
        if (duedaycutoffdays != that.duedaycutoffdays) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + vbDueday;
        result = 31 * result + duedaycutoffdays;
