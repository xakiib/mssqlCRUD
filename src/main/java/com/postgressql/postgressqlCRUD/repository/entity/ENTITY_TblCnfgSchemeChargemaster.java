...
@Entity
@Table(name = "TBL_CNFG_SCHEME_CHARGEMASTER", schema = "dbo", catalog = "master")
public class ENTITY_TblCnfgSchemeChargemaster {
    ...
    @Basic
    @Column(name = "CHARGEID", nullable = false, precision = 0, insertable=false, updatable=false)
    ...
    @OneToMany(mappedBy = "tblCnfgSchemeChargemasterByTcscmrecid")
    private Collection<ENTITY_TblCnfgSchemeChargedetail> tblCnfgSchemeChargedetailsByRecid;
    @ManyToOne
    ...
    @ManyToOne
    @JoinColumn(name = "CHARGEID", referencedColumnName = "CHARGEID", nullable = false)
    private ENTITY_TblCnfgMstCharges tblCnfgMstChargesByChargeid;
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblCnfgSchemeChargemaster that = (ENTITY_TblCnfgSchemeChargemaster) o;
    ...
    public Collection<ENTITY_TblCnfgSchemeChargedetail> getTblCnfgSchemeChargedetailsByRecid() {
        return tblCnfgSchemeChargedetailsByRecid;
    }

    public void setTblCnfgSchemeChargedetailsByRecid(Collection<ENTITY_TblCnfgSchemeChargedetail> tblCnfgSchemeChargedetailsByRecid) {
        this.tblCnfgSchemeChargedetailsByRecid = tblCnfgSchemeChargedetailsByRecid;
    }
    ...
    public ENTITY_TblCnfgMstCharges getTblCnfgMstChargesByChargeid() {
        return tblCnfgMstChargesByChargeid;
    }

    public void setTblCnfgMstChargesByChargeid(ENTITY_TblCnfgMstCharges tblCnfgMstChargesByChargeid) {
        this.tblCnfgMstChargesByChargeid = tblCnfgMstChargesByChargeid;
    }
}
