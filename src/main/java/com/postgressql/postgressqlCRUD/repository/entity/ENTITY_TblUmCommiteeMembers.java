...
@Entity
@Table(name = "TBL_UM_COMMITEE_MEMBERS", schema = "dbo", catalog = "master")
public class ENTITY_TblUmCommiteeMembers {
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Id
    @Column(name = "RECID", nullable = false, precision = 0)
    private int recid;
    @Basic
    @Column(name = "COMMITEEID", nullable = false, precision = 0, insertable=false, updatable=false)
    ...
    @ManyToOne
    @JoinColumn(name = "COMMITEEID", referencedColumnName = "COMMITEEID", nullable = false)
    private ENTITY_TblUmCommiteeMaster tblUmCommiteeMasterByCommiteeid;
    @ManyToOne
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblUmCommiteeMembers that = (ENTITY_TblUmCommiteeMembers) o;
    ...
    public ENTITY_TblUmCommiteeMaster getTblUmCommiteeMasterByCommiteeid() {
        return tblUmCommiteeMasterByCommiteeid;
    }

    public void setTblUmCommiteeMasterByCommiteeid(ENTITY_TblUmCommiteeMaster tblUmCommiteeMasterByCommiteeid) {
        this.tblUmCommiteeMasterByCommiteeid = tblUmCommiteeMasterByCommiteeid;
    }
