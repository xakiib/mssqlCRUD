...
@Entity
@Table(name = "TBL_CNFG_VB_KEYS", schema = "dbo", catalog = "master")
public class ENTITY_TblCnfgVbKeys {
    @Basic
    ...
    @Basic
    @Column(name = "KEYDESC1", nullable = false, length = 150)
    private String keydesc1;
    @Basic
    @Column(name = "KEYDESC2", nullable = true, length = 150)
    private String keydesc2;
    @Basic
    @Column(name = "KEYDESC3", nullable = true, length = 150)
    private String keydesc3;
    @Basic
    ...
    @OneToMany(mappedBy = "tblCnfgVbKeysByKeycode")
    private Collection<ENTITY_TblCnfgVbValues> tblCnfgVbValuesByKeycode;
    ...
    public String getKeydesc1() {
        return keydesc1;
    }

    public void setKeydesc1(String keydesc1) {
        this.keydesc1 = keydesc1;
    }

    public String getKeydesc2() {
        return keydesc2;
    }

    public void setKeydesc2(String keydesc2) {
        this.keydesc2 = keydesc2;
    }

    public String getKeydesc3() {
        return keydesc3;
    }

    public void setKeydesc3(String keydesc3) {
        this.keydesc3 = keydesc3;
    }
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblCnfgVbKeys that = (ENTITY_TblCnfgVbKeys) o;
        ...
        if (keydesc1 != null ? !keydesc1.equals(that.keydesc1) : that.keydesc1 != null) return false;
        if (keydesc2 != null ? !keydesc2.equals(that.keydesc2) : that.keydesc2 != null) return false;
        if (keydesc3 != null ? !keydesc3.equals(that.keydesc3) : that.keydesc3 != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (keydesc1 != null ? keydesc1.hashCode() : 0);
        result = 31 * result + (keydesc2 != null ? keydesc2.hashCode() : 0);
        result = 31 * result + (keydesc3 != null ? keydesc3.hashCode() : 0);
    ...
    public Collection<ENTITY_TblCnfgVbValues> getTblCnfgVbValuesByKeycode() {
        return tblCnfgVbValuesByKeycode;
    }

    public void setTblCnfgVbValuesByKeycode(Collection<ENTITY_TblCnfgVbValues> tblCnfgVbValuesByKeycode) {
        this.tblCnfgVbValuesByKeycode = tblCnfgVbValuesByKeycode;
    }
}
