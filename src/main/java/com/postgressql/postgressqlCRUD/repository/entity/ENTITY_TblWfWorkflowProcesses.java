...
@Entity
@Table(name = "TBL_WF_WORKFLOW_PROCESSES", schema = "dbo", catalog = "master")
public class ENTITY_TblWfWorkflowProcesses {
    ...
    private int seqno;
    @Basic
    @Column(name = "PROCESSID", nullable = true, precision = 0, insertable=false, updatable=false)
    private Integer processid;
    @Basic
    @Column(name = "RULEID", nullable = true, precision = 0)
    private Integer ruleid;
    @Basic
    @Column(name = "VB_PROCESSTRIGGER", nullable = true, precision = 0)
    private Integer vbProcesstrigger;
    @Basic
    @Column(name = "DISPLAYNAME", nullable = true, length = 50)
    private String displayname;
    @Basic
    @Column(name = "DISPLAYNAME1", nullable = true, length = 50)
    private String displayname1;
    @Basic
    @Column(name = "DISPLAYNAME2", nullable = true, length = 50)
    ...
    private ENTITY_TblWfMasterProcess tblWfMasterProcessByProcessid;
    ...
    public Integer getVbProcesstrigger() {
        return vbProcesstrigger;
    }

    public void setVbProcesstrigger(Integer vbProcesstrigger) {
        this.vbProcesstrigger = vbProcesstrigger;
    }
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblWfWorkflowProcesses that = (ENTITY_TblWfWorkflowProcesses) o;
        ...
        if (vbProcesstrigger != null ? !vbProcesstrigger.equals(that.vbProcesstrigger) : that.vbProcesstrigger != null)
            return false;
        if (displayname != null ? !displayname.equals(that.displayname) : that.displayname != null) return false;
        if (displayname1 != null ? !displayname1.equals(that.displayname1) : that.displayname1 != null) return false;
        if (displayname2 != null ? !displayname2.equals(that.displayname2) : that.displayname2 != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (vbProcesstrigger != null ? vbProcesstrigger.hashCode() : 0);
        result = 31 * result + (displayname != null ? displayname.hashCode() : 0);
        result = 31 * result + (displayname1 != null ? displayname1.hashCode() : 0);
        result = 31 * result + (displayname2 != null ? displayname2.hashCode() : 0);
    ...
    public ENTITY_TblWfMasterProcess getTblWfMasterProcessByProcessid() {
        return tblWfMasterProcessByProcessid;
    }

    public void setTblWfMasterProcessByProcessid(ENTITY_TblWfMasterProcess tblWfMasterProcessByProcessid) {
        this.tblWfMasterProcessByProcessid = tblWfMasterProcessByProcessid;
    }
}
