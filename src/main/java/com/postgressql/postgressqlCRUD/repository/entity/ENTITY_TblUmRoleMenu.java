...
@Entity
@Table(name = "TBL_UM_ROLE_MENU", schema = "dbo", catalog = "master")
public class ENTITY_TblUmRoleMenu {
    ...
    private int roleid;
    @Basic
    @Column(name = "MENUID", nullable = false, precision = 0, insertable=false, updatable=false)
    private int menuid;
    @Basic
    @Column(name = "ALLOWDATAEDIT", nullable = false)
    private boolean allowdataedit;
    @Basic
    ...
    private ENTITY_TblCnfgMstMenu tblCnfgMstMenuByMenuid;
    ...
    public boolean isAllowdataedit() {
        return allowdataedit;
    }

    public void setAllowdataedit(boolean allowdataedit) {
        this.allowdataedit = allowdataedit;
    }
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblUmRoleMenu that = (ENTITY_TblUmRoleMenu) o;

        if (recid != that.recid) return false;
        if (roleid != that.roleid) return false;
        if (menuid != that.menuid) return false;
        if (allowdataedit != that.allowdataedit) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (allowdataedit ? 1 : 0);
    ...
    public ENTITY_TblCnfgMstMenu getTblCnfgMstMenuByMenuid() {
        return tblCnfgMstMenuByMenuid;
    }

    public void setTblCnfgMstMenuByMenuid(ENTITY_TblCnfgMstMenu tblCnfgMstMenuByMenuid) {
        this.tblCnfgMstMenuByMenuid = tblCnfgMstMenuByMenuid;
    }
}
