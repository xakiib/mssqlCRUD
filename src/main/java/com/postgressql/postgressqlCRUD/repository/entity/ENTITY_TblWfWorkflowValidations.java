...
@Entity
@Table(name = "TBL_WF_WORKFLOW_VALIDATIONS", schema = "dbo", catalog = "master")
public class ENTITY_TblWfWorkflowValidations {
    ...
    @Basic
    @Column(name = "MESSAGEDESC1", nullable = true, length = 1000)
    private String messagedesc1;
    @Basic
    @Column(name = "MESSAGEDESC2", nullable = true, length = 1000)
    private String messagedesc2;
    @Basic
    @Column(name = "MESSAGEDESC3", nullable = true, length = 1000)
    private String messagedesc3;
    @Basic
    ...
    public void setMessagedesc1(String messagedesc1) {
        this.messagedesc1 = messagedesc1;
    }

    public String getMessagedesc2() {
        return messagedesc2;
    }

    public void setMessagedesc2(String messagedesc2) {
        this.messagedesc2 = messagedesc2;
    }

    public String getMessagedesc3() {
        return messagedesc3;
    }

    public void setMessagedesc3(String messagedesc3) {
        this.messagedesc3 = messagedesc3;
    }
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblWfWorkflowValidations that = (ENTITY_TblWfWorkflowValidations) o;
        ...
        if (messagedesc1 != null ? !messagedesc1.equals(that.messagedesc1) : that.messagedesc1 != null) return false;
        if (messagedesc2 != null ? !messagedesc2.equals(that.messagedesc2) : that.messagedesc2 != null) return false;
        if (messagedesc3 != null ? !messagedesc3.equals(that.messagedesc3) : that.messagedesc3 != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (messagedesc1 != null ? messagedesc1.hashCode() : 0);
        result = 31 * result + (messagedesc2 != null ? messagedesc2.hashCode() : 0);
        result = 31 * result + (messagedesc3 != null ? messagedesc3.hashCode() : 0);
