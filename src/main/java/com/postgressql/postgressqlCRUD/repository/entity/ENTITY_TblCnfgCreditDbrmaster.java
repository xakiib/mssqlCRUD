...
@Entity
@Table(name = "TBL_CNFG_CREDIT_DBRMASTER", schema = "dbo", catalog = "master")
public class ENTITY_TblCnfgCreditDbrmaster {
    ...
    @Basic
    @Column(name = "MAXDBR", nullable = false, precision = 2)
    ...
    public void setMaxdbr(BigDecimal maxdbr) {
        this.maxdbr = maxdbr;
    }
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblCnfgCreditDbrmaster that = (ENTITY_TblCnfgCreditDbrmaster) o;
        ...
        if (maxdbr != null ? !maxdbr.equals(that.maxdbr) : that.maxdbr != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (maxdbr != null ? maxdbr.hashCode() : 0);
