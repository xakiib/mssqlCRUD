...
@Entity
@Table(name = "TBL_CNFG_SCHEME_PROFITRATE", schema = "dbo", catalog = "master")
public class ENTITY_TblCnfgSchemeProfitrate {
    ...
    private int ruleid;
    @Basic
    @Column(name = "VB_PROFITRATETYPE", nullable = false, precision = 0)
    private int vbProfitratetype;
    @Basic
    @Column(name = "PROFITRATE", nullable = true, precision = 2)
    private BigDecimal profitrate;
    @Basic
    @Column(name = "MINLOCK", nullable = false, precision = 2)
    private BigDecimal minlock;
    @Basic
    @Column(name = "MAXLOCK", nullable = false, precision = 2)
    private BigDecimal maxlock;
    @Basic
    @Column(name = "VB_PROFITRATEBASES", nullable = false, precision = 0)
    private int vbProfitratebases;
    @Basic
    ...
    public int getVbProfitratetype() {
        return vbProfitratetype;
    }

    public void setVbProfitratetype(int vbProfitratetype) {
        this.vbProfitratetype = vbProfitratetype;
    }
    ...
    public BigDecimal getMinlock() {
        return minlock;
    }

    public void setMinlock(BigDecimal minlock) {
    ...
    public int getVbProfitratebases() {
        return vbProfitratebases;
    }

    public void setVbProfitratebases(int vbProfitratebases) {
        this.vbProfitratebases = vbProfitratebases;
    }
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblCnfgSchemeProfitrate that = (ENTITY_TblCnfgSchemeProfitrate) o;

        if (recid != that.recid) return false;
        if (schemeid != that.schemeid) return false;
        if (ruleid != that.ruleid) return false;
        if (vbProfitratetype != that.vbProfitratetype) return false;
        if (vbProfitratebases != that.vbProfitratebases) return false;
        ...
        if (minlock != null ? !minlock.equals(that.minlock) : that.minlock != null) return false;
        if (maxlock != null ? !maxlock.equals(that.maxlock) : that.maxlock != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + vbProfitratetype;
        result = 31 * result + (profitrate != null ? profitrate.hashCode() : 0);
        result = 31 * result + (minlock != null ? minlock.hashCode() : 0);
        result = 31 * result + (maxlock != null ? maxlock.hashCode() : 0);
        result = 31 * result + vbProfitratebases;
