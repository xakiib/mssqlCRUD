...
@Entity
@Table(name = "TBL_DATA_CIF_BANKTRANSDTL", schema = "dbo", catalog = "master")
public class ENTITY_TblDataCifBanktransdtl {
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Id
    @Column(name = "RECID", nullable = false, precision = 0)
    private int recid;
    @Basic
    @Column(name = "BANKRECID", nullable = true, precision = 0, insertable=false, updatable=false)
    private Integer bankrecid;
    @Basic
    ...
    @Basic
    @Column(name = "CREDITAMOUNT", nullable = true, precision = 2)
    private BigDecimal creditamount;
    @Basic
    @Column(name = "DEBITAMOUNT", nullable = true, precision = 2)
    private BigDecimal debitamount;
    @Basic
    @Column(name = "RUNNINGBALANCE", nullable = true, precision = 2)
    ...
    @ManyToOne
    @JoinColumn(name = "BANKRECID", referencedColumnName = "RECID")
    private ENTITY_TblDataCifBank tblDataCifBankByBankrecid;
    @ManyToOne
    ...
    public Integer getBankrecid() {
        return bankrecid;
    }

    public void setBankrecid(Integer bankrecid) {
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblDataCifBanktransdtl that = (ENTITY_TblDataCifBanktransdtl) o;

        if (recid != that.recid) return false;
        if (recstatus != that.recstatus) return false;
        if (bankrecid != null ? !bankrecid.equals(that.bankrecid) : that.bankrecid != null) return false;
        ...
        if (runningbalance != null ? !runningbalance.equals(that.runningbalance) : that.runningbalance != null)
            return false;
    ...
    public int hashCode() {
        int result = recid;
        result = 31 * result + (bankrecid != null ? bankrecid.hashCode() : 0);
    ...
    public ENTITY_TblDataCifBank getTblDataCifBankByBankrecid() {
        return tblDataCifBankByBankrecid;
    }

    public void setTblDataCifBankByBankrecid(ENTITY_TblDataCifBank tblDataCifBankByBankrecid) {
        this.tblDataCifBankByBankrecid = tblDataCifBankByBankrecid;
    }
