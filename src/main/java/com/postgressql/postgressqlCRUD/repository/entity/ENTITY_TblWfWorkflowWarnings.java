...
@Entity
@Table(name = "TBL_WF_WORKFLOW_WARNINGS", schema = "dbo", catalog = "master")
public class ENTITY_TblWfWorkflowWarnings {
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblWfWorkflowWarnings that = (ENTITY_TblWfWorkflowWarnings) o;
