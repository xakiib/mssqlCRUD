...
@Entity
@Table(name = "TBL_WF_WORKFLOW_TEMPLATES", schema = "dbo", catalog = "master")
public class ENTITY_TblWfWorkflowTemplates {
    ...
    @Basic
    @Column(name = "TEMPLATEID", nullable = true, precision = 0, insertable=false, updatable=false)
    private Integer templateid;
    @Basic
    @Column(name = "ALLOWADDTODOCUMENT", nullable = false)
    private boolean allowaddtodocument;
    @Basic
    ...
    private ENTITY_TblWfMasterTemplate tblWfMasterTemplateByTemplateid;
    ...
    public boolean isAllowaddtodocument() {
        return allowaddtodocument;
    }

    public void setAllowaddtodocument(boolean allowaddtodocument) {
        this.allowaddtodocument = allowaddtodocument;
    }
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblWfWorkflowTemplates that = (ENTITY_TblWfWorkflowTemplates) o;

        if (recid != that.recid) return false;
        if (workflowid != that.workflowid) return false;
        if (allowaddtodocument != that.allowaddtodocument) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (allowaddtodocument ? 1 : 0);
    ...
    public ENTITY_TblWfMasterTemplate getTblWfMasterTemplateByTemplateid() {
        return tblWfMasterTemplateByTemplateid;
    }

    public void setTblWfMasterTemplateByTemplateid(ENTITY_TblWfMasterTemplate tblWfMasterTemplateByTemplateid) {
        this.tblWfMasterTemplateByTemplateid = tblWfMasterTemplateByTemplateid;
    }
}
