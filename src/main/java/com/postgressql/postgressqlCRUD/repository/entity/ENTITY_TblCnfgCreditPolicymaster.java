...
@Entity
@Table(name = "TBL_CNFG_CREDIT_POLICYMASTER", schema = "dbo", catalog = "master")
public class ENTITY_TblCnfgCreditPolicymaster {
    ...
    @Basic
    @Column(name = "VB_CREDITFLOWMETHOD", nullable = false, precision = 0)
    private int vbCreditflowmethod;
    @Basic
    @Column(name = "MAXPROFITRATEDEVIATION", nullable = false, precision = 2)
    private BigDecimal maxprofitratedeviation;
    @Basic
    @Column(name = "MINAPPROVALSREQUIRED", nullable = false)
    private int minapprovalsrequired;
    @Basic
    @Column(name = "AUTOAPPROVALALLOWED", nullable = false)
    private boolean autoapprovalallowed;
    @Basic
    @Column(name = "EXCEPTIONALLOWED", nullable = false)
    ...
    public int getVbCreditflowmethod() {
        return vbCreditflowmethod;
    }

    public void setVbCreditflowmethod(int vbCreditflowmethod) {
        this.vbCreditflowmethod = vbCreditflowmethod;
    }

    public BigDecimal getMaxprofitratedeviation() {
        return maxprofitratedeviation;
    }

    public void setMaxprofitratedeviation(BigDecimal maxprofitratedeviation) {
        this.maxprofitratedeviation = maxprofitratedeviation;
    }
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblCnfgCreditPolicymaster that = (ENTITY_TblCnfgCreditPolicymaster) o;

        if (recid != that.recid) return false;
        if (financierid != that.financierid) return false;
        if (vbCreditflowmethod != that.vbCreditflowmethod) return false;
        if (minapprovalsrequired != that.minapprovalsrequired) return false;
        if (autoapprovalallowed != that.autoapprovalallowed) return false;
        if (exceptionallowed != that.exceptionallowed) return false;
        ...
        if (subproductcode != null ? !subproductcode.equals(that.subproductcode) : that.subproductcode != null)
            return false;
        if (maxprofitratedeviation != null ? !maxprofitratedeviation.equals(that.maxprofitratedeviation) : that.maxprofitratedeviation != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + vbCreditflowmethod;
        result = 31 * result + (maxprofitratedeviation != null ? maxprofitratedeviation.hashCode() : 0);
        result = 31 * result + minapprovalsrequired;
        result = 31 * result + (autoapprovalallowed ? 1 : 0);
        result = 31 * result + (exceptionallowed ? 1 : 0);
