...
@Entity
@Table(name = "TBL_UM_COMMITEE_ROLE", schema = "dbo", catalog = "master")
public class ENTITY_TblUmCommiteeRole {
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblUmCommiteeRole that = (ENTITY_TblUmCommiteeRole) o;
