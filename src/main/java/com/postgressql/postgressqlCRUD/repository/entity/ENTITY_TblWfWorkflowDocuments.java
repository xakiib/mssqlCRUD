...
@Entity
@Table(name = "TBL_WF_WORKFLOW_DOCUMENTS", schema = "dbo", catalog = "master")
public class ENTITY_TblWfWorkflowDocuments {
    ...
    @Basic
    @Column(name = "DOCUMENTID", nullable = true, precision = 0, insertable=false, updatable=false)
    ...
    private ENTITY_TblWfMasterDocument tblWfMasterDocumentByDocumentid;
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblWfWorkflowDocuments that = (ENTITY_TblWfWorkflowDocuments) o;
    ...
    public ENTITY_TblWfMasterDocument getTblWfMasterDocumentByDocumentid() {
        return tblWfMasterDocumentByDocumentid;
    }

    public void setTblWfMasterDocumentByDocumentid(ENTITY_TblWfMasterDocument tblWfMasterDocumentByDocumentid) {
        this.tblWfMasterDocumentByDocumentid = tblWfMasterDocumentByDocumentid;
    }
}
