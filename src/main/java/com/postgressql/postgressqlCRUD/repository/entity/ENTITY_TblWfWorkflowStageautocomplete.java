...
@Entity
@Table(name = "TBL_WF_WORKFLOW_STAGEAUTOCOMPLETE", schema = "dbo", catalog = "master")
public class ENTITY_TblWfWorkflowStageautocomplete {
    ...
    @Basic
    @Column(name = "VB_STAGEDECISION", nullable = true, precision = 0)
    private Integer vbStagedecision;
    @Basic
    ...
    public Integer getVbStagedecision() {
        return vbStagedecision;
    }

    public void setVbStagedecision(Integer vbStagedecision) {
        this.vbStagedecision = vbStagedecision;
    }
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblWfWorkflowStageautocomplete that = (ENTITY_TblWfWorkflowStageautocomplete) o;
        ...
        if (vbStagedecision != null ? !vbStagedecision.equals(that.vbStagedecision) : that.vbStagedecision != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (vbStagedecision != null ? vbStagedecision.hashCode() : 0);
