...
@Entity
@Table(name = "TBL_CNFG_SCHEME_DOWNPAYMENT", schema = "dbo", catalog = "master")
public class ENTITY_TblCnfgSchemeDownpayment {
    ...
    private int ruleid;
    @Basic
    @Column(name = "DOWNPAYMENTPERCENT", nullable = true, precision = 2)
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblCnfgSchemeDownpayment that = (ENTITY_TblCnfgSchemeDownpayment) o;
        ...
        if (downpaymentpercent != null ? !downpaymentpercent.equals(that.downpaymentpercent) : that.downpaymentpercent != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (downpaymentpercent != null ? downpaymentpercent.hashCode() : 0);
