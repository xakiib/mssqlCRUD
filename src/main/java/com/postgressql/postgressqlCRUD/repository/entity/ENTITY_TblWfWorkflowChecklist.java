...
@Entity
@Table(name = "TBL_WF_WORKFLOW_CHECKLIST", schema = "dbo", catalog = "master")
public class ENTITY_TblWfWorkflowChecklist {
    ...
    @Basic
    @Column(name = "CHECKLISTID", nullable = true, precision = 0, insertable=false, updatable=false)
    private Integer checklistid;
    @Basic
    @Column(name = "VB_REQUIREDVALIDATION", nullable = true, precision = 0)
    private Integer vbRequiredvalidation;
    @Basic
    ...
    private ENTITY_TblWfMasterChecklist tblWfMasterChecklistByChecklistid;
    ...
    public Integer getVbRequiredvalidation() {
        return vbRequiredvalidation;
    }

    public void setVbRequiredvalidation(Integer vbRequiredvalidation) {
        this.vbRequiredvalidation = vbRequiredvalidation;
    }
    ...
    public boolean equals(Object o) {
        ...
        ENTITY_TblWfWorkflowChecklist that = (ENTITY_TblWfWorkflowChecklist) o;
        ...
        if (vbRequiredvalidation != null ? !vbRequiredvalidation.equals(that.vbRequiredvalidation) : that.vbRequiredvalidation != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (vbRequiredvalidation != null ? vbRequiredvalidation.hashCode() : 0);
    ...
    public ENTITY_TblWfMasterChecklist getTblWfMasterChecklistByChecklistid() {
        return tblWfMasterChecklistByChecklistid;
    }

    public void setTblWfMasterChecklistByChecklistid(ENTITY_TblWfMasterChecklist tblWfMasterChecklistByChecklistid) {
        this.tblWfMasterChecklistByChecklistid = tblWfMasterChecklistByChecklistid;
    }
}
